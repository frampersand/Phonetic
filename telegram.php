...
class Telegram {
    ...
    /**
     * Personal modification to the original class made by Gabriele Grillo 
     * The original lacked a function to summon the answerInlineQuery method.
     */
    public function inlineQuery(array $content) {
